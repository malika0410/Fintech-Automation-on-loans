...
print(f"Total amount of all the loans is :",total_amount_of_loans)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan_price=total_amount_of_loans/total_number_of_loans  #average loan price is the total amount of loan divided by length of the loan.
...
# YOUR CODE HERE!
present_value=calculate_present_value(1000,12,.20)          #Calling a function defined above to get present value.
...
# YOUR CODE HERE!
print(f"List of inexpensive loan is:",inexpensive_loans)   
